                            ...
                            @foreach($data['rasberryPis'] as $rasberryPi)
                              <tr class="bg-white border-b">
                                <th scope="row" class="px-6 py-4 font-medium text-black whitespace-nowrap">
                                  ...
                                  <th scope="row" class="px-6 py-4 font-medium text-black whitespace-nowrap text-center">
                                    <span class="w-2 h-2 inline-block {{ $rasberryPi->rasberry_pi->isOnline() ? 'bg-green' : 'bg-red-600' }} rounded-full"></span> {{ $rasberryPi->rasberry_pi->isOnline() ? __("messages.online") : __("messages.offline")}}                                    
                                  </td>                              
                              </tr>                          
                              @endforeach
                            @else
