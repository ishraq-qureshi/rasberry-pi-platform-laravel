      ...
      <div class="max-w-7xl mx-auto flex flex-col gap-5 sm:px-6 lg:px-8">
          <div class="overflow-hidden flex gap-2">
            <div class="block flex-1 p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100">
              ...
              <h5 class="mb-2 text-5xl font-bold tracking-tight text-gray-900">{{ $rasberryPi->analytics->cpu_usage }}</h5>
            </div>
            <div class="block flex-1 p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100">
              <p class="font-normal text-sm text-gray-700 dark:text-gray-400">RAM Usage</p>
              <h5 class="mb-2 text-5xl font-bold tracking-tight text-gray-900">{{ $rasberryPi->analytics->ram_usage }}</h5>
            </div>
            <div class="block flex-1 p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100">
              <p class="font-normal text-sm text-gray-700 dark:text-gray-400">Temperature</p>
              <h5 class="mb-2 text-5xl font-bold tracking-tight text-gray-900">{{ $rasberryPi->analytics->temperature }}</h5>
            </div>
            <div class="block flex-1 p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100">
              <p class="font-normal text-sm text-gray-700 dark:text-gray-400">Storage Usage</p>
              <h5 class="mb-2 text-5xl font-bold tracking-tight text-gray-900">{{ $rasberryPi->analytics->storage_usage }}</h5>
            </div>
          </div>
              ...
              <div class="p-6 text-gray-900">
                <ul class="flex flex-col gap-4">
                  <li class="flex gap-2 justify-between items-center">
                    ...
                    <span>{{ $rasberryPi->analytics->serial_number }}</span>
                  </li>
                  <li class="flex gap-2 justify-between items-center">
                    <span class="font-bold">Modal:</span>
                    <span>{{ $rasberryPi->analytics->model }}</span>
                  </li>
                  <li class="flex gap-2 justify-between items-center">
                    <span class="font-bold">IP Address Lan:</span>
                    <span>{{ $rasberryPi->analytics->ip_address_lan	 }}</span>
                  </li>
                  <li class="flex gap-2 justify-between items-center">
                    <span class="font-bold">IP Address WAN:</span>
                    <span>{{ $rasberryPi->analytics->ip_address_wlan }}</span>
                  </li>
                  <li class="flex gap-2 justify-between items-center">
                    <span class="font-bold">Last Updated:</span>
                    <span>{{ $carbon::parse($rasberryPi->analytics->updated_at)->diffForHumans() }}</span>
                  </li>
